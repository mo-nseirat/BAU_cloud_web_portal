...
class Config:
    ...
    PROXMOX_HOST       = os.environ.get('PROXMOX_HOST', '192.168.99.1')
    PROXMOX_PORT       = 8006
    PROXMOX_USER       = os.environ.get('PROXMOX_USER', 'root@pam')
    PROXMOX_PASSWORD   = os.environ.get('PROXMOX_PASSWORD', 'your-proxmox-password')
    PROXMOX_NODE       = os.environ.get('PROXMOX_NODE', 'pve')   # run: pvesh get /nodes
    ...
    VM_TEMPLATES = {
        'Ubuntu 22.04 LTS':    900,
        'Ubuntu 20.04 LTS':    901,
        'Debian 12':           902,
        'CentOS Stream 9':     903,
        'Windows Server 2022': 904,
        'Windows 10 Pro':      905,
    }
